        ...
        $coaches = [
            ...
            [
                ...
                'posts' => [
                    ...
                    ['title' => 'Technika drepu pre začiatočníkov — video', 'content' => 'Kompletný video návod na správnu techniku drepu krok za krokom. Ukážem ti nastavenie stopy, hĺbku, polohu chrbta aj dýchanie.', 'media_type' => 'video', 'video_duration' => '14:22', 'is_exclusive' => false, 'hours_ago' => 72],
                    ...
                    ['title' => 'Ranný tréning o 6:00 — záznamy z posilňovne', 'content' => 'Dnes som natočil celý ranný tréning. Motivácia, technika, výber váh — všetko naživo.', 'media_type' => 'video', 'video_duration' => '8:15', 'is_exclusive' => true, 'hours_ago' => 8],
                    ['title' => 'Môj program na 12 týždňov — kompletný plán', 'content' => 'Tento program ti pomôže pribúdať 1–2 kg čistej svaloviny za mesiac. Obsahuje rozdelenie tréningov, výživový plán a tipy na regeneráciu. Garantujem výsledky.', 'media_type' => 'video', 'video_duration' => '28:45', 'is_exclusive' => true, 'hours_ago' => 3],
            ...
            [
                ...
                'posts' => [
                    ...
                    ['title' => 'HIIT tréning doma bez náradia — 30 minút', 'content' => 'Spaľuj tuk efektívne aj bez posilňovne. Tento tréning som zostavila špeciálne pre ženy začiatočníčky.', 'media_type' => 'video', 'video_duration' => '31:08', 'is_exclusive' => false, 'hours_ago' => 80],
                    ...
                    ['title' => 'Jedálniček na celý týždeň — 1600 kcal', 'content' => 'Kompletný jedálniček vrátane receptov, nákupného zoznamu a makier pre každé jedlo. Zostavený pre ženy so sedavým zamestnaním.', 'media_type' => 'video', 'video_duration' => '18:55', 'is_exclusive' => true, 'hours_ago' => 10],
            ...
            [
                ...
                'posts' => [
                    ...
                    ['title' => 'Ranný strečing 20 minút — CrossFit recovery', 'content' => 'Ideálna ranná rutina po náročnom WOD. Zamerajme sa na bedrá, plecia a hrudník.', 'media_type' => 'video', 'video_duration' => '20:14', 'is_exclusive' => false, 'hours_ago' => 70],
                    ['title' => 'Ako robiť muscle-up od nuly', 'content' => 'Muscle-up je jeden z najtesnejších crossfit pohybov. Tu je postupný plán od nulových začiatočníkov.', 'media_type' => 'video', 'video_duration' => '16:40', 'is_exclusive' => false, 'hours_ago' => 44],
                    ...
                    ['title' => 'Mobility rutina pre crossfitérov — 20 minút denne', 'content' => 'Bez správnej mobility sa zraníš skôr či neskôr. Tu je môj overený protokol, ktorý robím každé ráno pred tréningom.', 'media_type' => 'video', 'video_duration' => '22:30', 'is_exclusive' => true, 'hours_ago' => 5],
                    ['title' => 'Môj 8-týždňový CrossFit program — úplné začiatočník', 'content' => 'Zostavil som program špeciálne pre ľudí, ktorí s CrossFitom začínajú. Žiadne predchádzajúce skúsenosti nie sú potrebné.', 'media_type' => 'video', 'video_duration' => '42:15', 'is_exclusive' => true, 'hours_ago' => 1],
                ],
            ],
            ...
            [
                ...
                'posts' => [
                    ...
                    ['title' => 'Meditácia pred spánkom — 15 minút', 'content' => 'Uvoľni myseľ pred spaním s touto riadenou meditáciou. Pomôže ti znížiť kortizol a zlepšiť kvalitu spánku.', 'media_type' => 'video', 'video_duration' => '15:00', 'is_exclusive' => false, 'hours_ago' => 90],
                    ...
                    ['title' => 'Yin joga pre hlboké uvoľnenie — 45 minút', 'content' => 'Yin joga pracuje s hlbokými tkanivami — fasciami a väzivom. Ideálna po náročnom týždni.', 'media_type' => 'video', 'video_duration' => '47:22', 'is_exclusive' => true, 'hours_ago' => 12],
                    ['title' => '30-dňová joga výzva — kompletný program', 'content' => 'Každý deň nová lekcia, postupne náročnejšia. Program je zostavený tak, aby si po 30 dňoch zvládol základné ásany správne a bez bolesti.', 'media_type' => 'video', 'video_duration' => '45:12', 'is_exclusive' => true, 'hours_ago' => 4],
                ],
            ],
            ...
            [
                ...
                'posts' => [
                    ...
                    ['title' => 'Bežecká technika pre začiatočníkov — video rozbor', 'content' => 'Správna technika behu ti ušetrí kolená a zlepší výkon. Analyzujem 5 najčastejších chýb začiatočníkov.', 'media_type' => 'video', 'video_duration' => '12:34', 'is_exclusive' => false, 'hours_ago' => 68],
                    ...
                    ['title' => 'Ranný beh 5 km — záznamy z Petržalky', 'content' => 'Dnes som natočil ranný beh pozdĺž Dunaja. Krásne ráno a veľa myšlienok o disciplíne a konzistencii.', 'media_type' => 'video', 'video_duration' => '9:45', 'is_exclusive' => false, 'hours_ago' => 18],
                    ['title' => 'Strečing po behu — 15 minút (povinné!)', 'content' => 'Ak vynecháš strečing, zaplatíš za to neskôr. Tu je moja minimálna rutina po každom behu.', 'media_type' => 'video', 'video_duration' => '16:10', 'is_exclusive' => true, 'hours_ago' => 6],
                    ['title' => 'Tréningový plán na maratón — 16 týždňov', 'content' => 'Kompletný plán vrátane dlhých behov, intervalov, regenerácie a výživovej stratégie na deň preteku. Odskúšané na vlastnej koži aj so stovkami klientov.', 'media_type' => 'video', 'video_duration' => '38:20', 'is_exclusive' => true, 'hours_ago' => 2],
                ],
            ],
            ...
            [
                ...
                'posts' => [
                    ...
                    ['title' => 'Ranný wellness rituál — 10 minút každé ráno', 'content' => 'Jednoduchá rutina, ktorá zmení tvoj deň. Denník, dýchanie a pohyb — všetko do 10 minút.', 'media_type' => 'video', 'video_duration' => '10:05', 'is_exclusive' => false, 'hours_ago' => 75],
                    ...
                    ['title' => 'Guided meditácia — uvoľnenie napätia v tele (30 min)', 'content' => 'Táto riadená meditácia cez body scan ťa naučí vnímať a uvoľňovať napätie v jednotlivých častiach tela.', 'media_type' => 'video', 'video_duration' => '30:40', 'is_exclusive' => true, 'hours_ago' => 7],
                    ['title' => 'Môj 7-dňový wellness reset — protokol', 'content' => 'Celý týždeň krok po kroku: spánková rutina, ranné rituály, výživa, pohyb a digitálny detox. Klienti hlásia o 60% nižší stres už po prvom týždni.', 'media_type' => 'video', 'video_duration' => '52:18', 'is_exclusive' => true, 'hours_ago' => 1],
                ],
            ],
        ];
