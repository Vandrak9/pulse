...
// keyword is the substring we search for in specialization (lowercase, diacritic-safe)
const CATEGORIES = [
...
function CoachCard({ coach }: { coach: Coach }) {
    ...
    return (
        ...
        >
            ...
            {coach.bio && (
                <p
                    className="mt-2 line-clamp-1 w-full text-center text-xs leading-relaxed"
                    style={{ color: '#9a8a7a' }}
                >
                    {coach.bio}
                </p>
            ...
            <div className="mt-2 flex items-center gap-2">
                {rating !== null && (
                    <>
                        <span className="flex items-center gap-0.5 text-xs" style={{ color: '#f5a623' }}>
                            ★
            ...
            <p className="font-serif text-lg font-bold sm:text-xl" style={{ color: '#c4714a' }}>
                ...
                {price > 0 && (
                    <span className="ml-1 font-sans text-xs font-normal" style={{ color: '#9a8a7a' }}>
                        / mesiac
                    </span>
                )}
            </p>
