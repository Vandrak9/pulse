            ...
            <div className="py-10" style={{ backgroundColor: '#faf6f0', minHeight: '80vh' }}>
                <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        ...
                        <p className="mb-5 text-sm" style={{ color: '#9a8a7a' }}>
                            Pre prijímanie platieb od predplatiteľov musíš prepojiť svoj Stripe účet.
                            PULSE si ponechá 15&nbsp;% z každej platby; zvyšných 85&nbsp;% ide priamo tebe.
                        </p>
                        ...
                        {coach?.stripe_account_id ? (
                            <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                                <div
                                    ...
                                    style={{ backgroundColor: '#edf7f0', color: '#4a7c59' }}
                                >
                                    <span>✓</span>
                                    <span>Stripe účet prepojený</span>
                                </div>
                                <a
                                    href="/stripe/connect/dashboard"
                                    className="rounded-xl border px-4 py-2.5 text-center text-sm font-medium transition hover:opacity-80"
